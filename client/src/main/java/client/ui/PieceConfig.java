...
public record PieceConfig(String whiteKing, String blackKing, String whiteQueen, String blackQueen, String whiteKnight,
    ...
    public static PieceConfig unicode = new PieceConfig(
    ...
    public static PieceConfig alphabetic = new PieceConfig(
